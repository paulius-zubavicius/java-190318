...
public class GiedriusImpl {
	...
	public List<List<Mokinys>> getReordered(Map<String, List<Mokinys>> mokiniai) {
		...
		if (!listasPo.get("0").isEmpty())
			result.add(listasPo.get("0"));
		if (!listasPo.get("1").isEmpty())
			result.add(listasPo.get("1"));
		if (!listasPo.get("2").isEmpty())
			result.add(listasPo.get("2"));
		if (!listasPo.get("3").isEmpty())
			result.add(listasPo.get("3"));
		if (!listasPo.get("4").isEmpty())
			result.add(listasPo.get("4"));
		if (!listasPo.get("5").isEmpty())
			result.add(listasPo.get("5"));
		if (!listasPo.get("6").isEmpty())
			result.add(listasPo.get("6"));
		if (!listasPo.get("7").isEmpty())
			result.add(listasPo.get("7"));
		if (!listasPo.get("8").isEmpty())
			result.add(listasPo.get("8"));
		if (!listasPo.get("9").isEmpty())
			result.add(listasPo.get("9"));
